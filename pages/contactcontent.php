            ...
            <div class="contact-us">
                <div class="informations">
                    <form>
                        ...
                        <label for="school-name">School/Organisation Name *</label><input type="text" name="" id="school-name" required >
                        <label for="oid-number">OID Number *</label><input type="text" name="" id="oid-number" required >
                        <label for="agreement-num">Erasmus+ Grant Agreement Number *</label><input type="text" name="" id="agreement-num" required >
