...
if (isset($_POST['basvuru-sil'])) {

    require_once('db/dbhelper.php');
    $db = new DBController();

    $basvuru_id = $_POST['basvuru-id'];
    $query = "DELETE FROM contact_us WHERE ID = $basvuru_id";
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        ...
                                        <tr>
                                            <form method="post">
                                                <td>
                                                    <input type="hidden" name="basvuru-id"
                                                ...
                                                <td>
                                                    <button type="submit" name="basvuru-sil"
